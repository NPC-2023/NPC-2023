...
function scene:create( event )
	...
	local speechbubble = display.newImageRect("image/npc/speechbubble.png", display.contentWidth, display.contentHeight/3)
	...
	local accept = display.newText("", speechbubble.x-150, speechbubble.y+80, "font/DOSGothic.ttf")
	...
	local memo = display.newImageRect("image/schoolfood/memo.png", display.contentWidth/4, display.contentHeight/5.5)
	memo.alpha = 0
