...
function scene:create( event )
	...
	local background = display.newImageRect("image/npc/place4.jpg", display.contentWidth*3, display.contentHeight)
	...
	--대사
	local t = {}
	t[1] = display.newText("여기서 뭐하고 있냥?", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[2] = display.newText("풀숲에 뭐가 떨어져 있어서 보고 있었어.", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[3] = display.newText("흠.. 잘 안 보이네? 저게 뭘까? ", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[4] = display.newText("우와 저건 내가 좋아하는 츄르다냥!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[5] = display.newText("정말? 원한다면 네가 가져도 돼!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)	
