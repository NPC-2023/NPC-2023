...
function scene:create( event )
	...
	local background = display.newImageRect("image/npc/place5.jpg", display.contentWidth*3, display.contentHeight)
	background.x = display.contentCenterX
    background.y = display.contentCenterY

 	local npc = display.newImageRect("image/npc/npc3.png", display.contentWidth/1.5, display.contentHeight/3)
	npc.x, npc.y = display.contentCenterX*2.5, display.contentHeight*0.75
	npc.xScale = -1
	...
	--대사
	local t = {}
	t[1] = display.newText("어? 귀여운 고양이네!\n안녕? 너 이름이 뭐야?", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[2] = display.newText("나는 고양이 왕국 일등 기사 "..mainName.."이다냥!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[3] = display.newText("일등 기사라니 정말 멋진데? 나도 너희 왕국에 가보고 싶어!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[4] = display.newText(" 후후.. 내가 다음에 데려가 주겠다냥! 나만 믿어냥!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[5] = display.newText("빨리 가 보고 싶다!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)	
