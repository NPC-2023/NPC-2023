...
function scene:create( event )
	...
	--대사
	local t = {}
	t[1] = display.newText("다시 재발급을 받아야 하나..?", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[2] = display.newText("그게 뭐냥?", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[3] = display.newText("학생증은 내가 이 학교에 소속된 학생임을 증명하는 문서야~", display.contentWidth*0.4, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[4] = display.newText("나도 갖고 싶다냥! 어디서 받는거냥?!", display.contentWidth*0.4, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[5] = display.newText("좋아! 나랑 같이 학생증 만들어 갈래?!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)	
