...
function scene:create( event )
	...
	local background = display.newImageRect("image/cafeteria.png",display.contentWidth, display.contentHeight) ---배경
	...
	--close 버튼
	local clear_close = display.newImageRect("image/exit.png", 150, 150)
	clear_close.x, clear_close.y = 950, 400
	clear_close.alpha = 0
	

	local fail_close = display.newImageRect("image/retry.png", 150, 150)
	...
	local backtomap = display.newImage("image/클리어창.png") --성공할 경우, 원래 코드 : display.newImageRect("image/클리어창.png", display.contentWidth/5, display.contentHeight/5 )
