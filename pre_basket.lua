...
function scene:create( event )
	...
	local background = display.newImageRect("image/npc/background1.jpg", display.contentWidth, display.contentHeight)
 	background.x, background.y = display.contentWidth/2, display.contentHeight/2

 	local npc = display.newImageRect("image/npc/npc3.png", 300, 300)
	...
	local function acceptQuest( event )
		...
		local speech2 = display.newText("뭔데냥?\n", 
