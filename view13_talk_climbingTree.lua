...
function scene:create( event )
	...
	local background = display.newImageRect("image/frontgate/gate.jpg", display.contentWidth*3, display.contentHeight)--배경이미지 
	...
	--대사
	local t = {}
	t[1] = display.newText("흐음... 목화솜으로 무얼 만들까...?", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[2] = display.newText("으아... 인간 세상은 너무 춥다냥...", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[3] = display.newText(mainName.. "아! 많이 추워?\n 그럼 과제 하고 남은 목화솜으로 고양이 옷을 만들어줄게", display.contentWidth*0.4, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[4] = display.newText("감동이다냥! \n 내가 나무를 잘 타니 나무 위에 있는 목화솜을 전부 가져올게냥.", display.contentWidth*0.4, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)
	t[5] = display.newText("나무가 높으니 조심해서 갔다와 " ..mainName.. "아!", display.contentWidth*0.3, display.contentHeight*0.73, "font/NanumSquareRoundR.ttf", 25)	
